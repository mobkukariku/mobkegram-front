...
<template>
  <div class="bg-[#34D399] w-[60px] h-screen flex flex-col items-center justify-between">
    ...
    <div v-if="profile" class="flex flex-col items-center justify-between mt-5">
      <Avatar :image="profile.pictureURL" size="large" class="mb-[70px] cursor-pointer hover:opacity-80 transition-opacity" shape="circle" @click="showProfileDialog = true"/>
